...
<table align="center">
	<tr>
    	<td>
            <fieldset>
           		 <legend align="center" style="font-size:30px;color:red">Change Password</legend>
                         ...
                         <tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    ...
                                    <input type="button" value="Cancel" name="btnCancel" onClick="window.location.replace('view_profile.php')" />		
